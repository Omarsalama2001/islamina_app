    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          //   subtitle: GetBuilder<QuranAudioSettingsController>(
          //     builder: (controller) {
          //       return Text(QuranReaderCache.getSelectedReaderFromCache().name,
          //           style: subtitleTextStyle);
          //     },
          //   ),
          //   dense: true,
                ...
                return Choice<String>.inline(
                  ...
                  itemBuilder: (state, i) {
                    return ChoiceChip(
                      ...
                      selectedColor: theme.colorScheme.primary,
                      selected: state
                          .selected(controller.speedChoice.values.toList()[i]),
                ...
                return Choice<String>.inline(
                  ...
                  itemBuilder: (state, i) {
                    return ChoiceChip(
                      ...
                      selectedColor: theme.colorScheme.primary,
                      selected: state
                          .selected(controller.repeatChoice.values.toList()[i]),
                      onSelected: state.onSelected(
                  ...
                  if (isBegin) {
                    controller.setQuranPlayRange(
                        playRange: controller.playRange
                            .copyWith(startSurah: surahId, startVerse: verseId),
                        isBegin: isBegin);
                  } else {
                    controller.setQuranPlayRange(
                        playRange: controller.playRange
