...
//                           onPressed: controller.currentIndex == views.length - 1
//                               ? () {
//                                   Get.put<QuranReadingController>(QuranReadingController());
//                                   Get.find<QuranReadingController>().pageNumber = controller.currentIndex + 1;
//                                   Get.find<QuranReadingController>().update();
//                                   Get.offAllNamed('/quran');
//                                 }
//                               : () {
//                                   controller.nextPage();
//                                 },
...
//                           ),
//                           child: Text(
//                             controller.currentIndex == views.length - 1 ? 'تم' : 'التالي',
//                             style: context.textTheme.titleMedium?.copyWith(
//                               color: context.theme.scaffoldBackgroundColor,
//                             ),
//                           ),
...
//                                 ],
//                                 onChanged: (value) {
//                                   if (controller.daysController.text.isNotEmpty) {
...
//                                           children: controller.units.asMap().entries.map((e) {
//                                             return InkWell(
//                                               onTap: () {
//                                                 if (controller.selectedUnit != e.value) {
//                                                   controller.selectedDestiny = 0;
//                                                 }
//                                                 controller.selectedUnit = e.value;
...
//                                                         border: Border.all(
//                                                           color: controller.selectedUnit == e.value ? context.theme.primaryColor : Colors.grey,
//                                                         ),
//                                                       ),
//                                                       child: CircleAvatar(
//                                                         radius: 6,
//                                                         backgroundColor: controller.selectedUnit == e.value ? context.theme.primaryColor : Colors.transparent,
//                                                       ),
//                                                     ),
//                                                   ],
//                                                 ),
...
//                               child: _SelectedCardItem(
//                                 title: 'القدر',
//                                 description: (controller.selectedDestiny + 1).toString(),
//                                 onTap: () {
//                                   Get.dialog(
//                                     AlertDialog(
//                                       backgroundColor: context.theme.scaffoldBackgroundColor,
...
//                                           itemCount: controller.listOfSelectedUnitIndex.length,
//                                           itemBuilder: (context, index) {
//                                             return InkWell(
//                                               onTap: () {
//                                                 controller.selectedDestiny = index;
//                                                 controller.calculateExpectedPeriod();
//                                                 controller.update();
//                                                 Get.back();
//                                               },
...
//                                                         shape: BoxShape.circle,
//                                                         border: Border.all(
//                                                           color: controller.selectedDestiny == controller.listOfSelectedUnitIndex[index] ? context.theme.primaryColor : Colors.grey,
//                                                         ),
//                                                       ),
//                                                       child: CircleAvatar(
//                                                         radius: 6,
//                                                         backgroundColor: controller.selectedDestiny == controller.listOfSelectedUnitIndex[index] ? context.theme.primaryColor : Colors.transparent,
//                                                       ),
//                                                     ),
//                                                   ],
//                                                 ),
...
//                               child: Column(
//                                 mainAxisSize: MainAxisSize.min,
//                                 children: controller.juz.asMap().entries.map((e) {
//                                   return InkWell(
//                                     onTap: () {
...
//                                               shape: BoxShape.circle,
//                                               border: Border.all(
//                                                 color: controller.selectedJuz == e.value ? context.theme.primaryColor : Colors.grey,
//                                               ),
//                                             ),
//                                             child: CircleAvatar(
//                                               radius: 6,
//                                               backgroundColor: controller.selectedJuz == e.value ? context.theme.primaryColor : Colors.transparent,
//                                             ),
//                                           ),
//                                         ],
//                                       ),
...
//                             } else {
//                               data = controller.expectedPeriodOfKhatma.toString();
//                               // data =
...
//                             String data = '';
//                             if (controller.calculateByNoOfDay) {
//                               data = controller.handleTextExpectedPeriodOfKhatma;
//                             } else {
//                               data = '${controller.selectedDestiny + 1} ${controller.selectedUnit}';
//                             }
//                             return Text(
//                               (controller.calculateByNoOfDay) && (data.isEmpty || controller.daysController.text.isEmpty) ? '0 صفحة' : data,
//                               style: context.textTheme.headlineSmall?.copyWith(
//                                 fontWeight: FontWeight.w600,
//                                 color: Colors.orange,
//                               ),
...
//                     decoration: BoxDecoration(
//                       color: controller.enableAlarm ? context.theme.primaryColor.withOpacity(0.2) : context.theme.primaryColor.withOpacity(0.1),
//                       borderRadius: const BorderRadius.all(
//                         Radius.circular(6),
//                       ),
//                     ),
...
//           GetBuilder<KhatmaController>(
//             builder: (controller) {
//               return controller.selectedTextTime != null && controller.enableAlarm
//                   ? Padding(
