...
abstract class Routes {
  ...
  static const RECITER_DOWNLOAD_MANAGER = _Paths.RECITER_DOWNLOAD_MANAGER;
...
abstract class _Paths {
  ...
  static const RECITER_DOWNLOAD_MANAGER = '/reciter-download-manager';
  static const AUDIO_PLAYER_CONTROLS = '/audio-player-controls';
  static const AUDIO_SETTINGS = '/audio-settings';
  static const QURAN_DISPLAY_SETTINGS = '/quran-display-settings';
  static const QIBLA_PAGE = '/qibla-page';
