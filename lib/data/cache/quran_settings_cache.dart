...
class QuranSettingsCache {
  ...
  static void setDisplayTwoPage({required bool value}) {
    prefs.setBool(isDisplayTwoPageKey, value);
  }
  ...
  static bool isDisplayTwoPageListen() {
    var isDisplayTwoPage = prefs.getBool(isDisplayTwoPageKey);
    if (isDisplayTwoPage == null) {
      isDisplayTwoPage = true;
      setWordByWordListen(isWordByWord: isDisplayTwoPage);
    }
    return isDisplayTwoPage;
  }
